...
void SamplerDemo::Init()
{
	...
	_camera->GetTransform()->SetPosition(Vec3(50.f, 50.f, -5.f));

	_texture = RESOURCES->Load<Texture>(L"Bg_P_01_1", L"..\\Resources\\Textures\\Bg_P_01_1.png");

	//// Player
	//_player = make_shared<GameObject>();
	//_player->GetOrAddTransform();
	//_player->AddComponent(make_shared<PlayerController>());
	//_player->GetTransform()->SetPosition(Vec3(50.f, 50.f, -2.f));
	////SCENE->LoadScene(L"Test");
	//_texture = RESOURCES->Load<Texture>(L"Slime_01", L"..\\Resources\\Textures\\Slime_01_1.png");
